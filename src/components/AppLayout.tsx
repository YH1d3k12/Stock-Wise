...
const navItems = [
  ...
  { to: "/fichas", label: "Receitas", icon: BookOpen },
...
function Onboarding({ onClose }: { onClose: () => void }) {
  ...
  const Icon = s.icon;
  return (
    <div className="fixed inset-0 z-50 bg-slate-950/60 backdrop-blur-sm grid place-items-center p-4 animate-fade-in">
      <div className="w-full max-w-2xl bg-white rounded-3xl shadow-2xl overflow-hidden">
        <div className="grid md:grid-cols-2">
          <div className="relative bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 p-10 text-white flex flex-col justify-between min-h-[420px]">
            ...
            <div className="relative">
              ...
              <div className="relative grid place-items-center h-24 w-24 rounded-3xl bg-white/15 backdrop-blur-md border border-white/20 shadow-xl">
          ...
          <div className="p-10 flex flex-col">
            ...
            <h2 className="mt-3 text-2xl font-semibold tracking-tight text-slate-900">{s.title}</h2>
  ...
  return (
    <div className="flex min-h-screen bg-slate-50 text-slate-900">
      ...
      <aside className="hidden md:flex w-60 shrink-0 flex-col border-r border-slate-200 bg-white">
        <div className="flex items-center gap-2.5 px-5 py-5 border-b border-slate-100">
          ...
          <div>
            ...
            <div className="text-[10px] uppercase tracking-widest text-slate-400 font-medium">Smart Inventory</div>
          </div>
        </div>
        ...
        <div className="p-3 border-t border-slate-100">
          <div className="flex items-center gap-3 p-2.5 rounded-xl bg-slate-50">
            <Avatar className="h-8 w-8">
              <AvatarFallback className="bg-blue-100 text-blue-700 text-xs font-medium">MR</AvatarFallback>
            </Avatar>
            <div className="flex-1 min-w-0">
              <div className="text-xs font-medium truncate">Marina Rossi</div>
              <div className="text-[10px] text-slate-500 truncate">Cantina Bella · Plano Pro</div>
            </div>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="flex items-center gap-4 px-4 md:px-8 py-4 border-b border-slate-200 bg-white">
          <div className="flex-1 min-w-0">
          ...
          <div className="hidden md:flex relative w-72">
            ...
            <Input placeholder="Buscar produtos, insumos..." className="pl-9 bg-slate-50 border-slate-200" />
          </div>
          <button className="relative grid place-items-center h-9 w-9 rounded-lg border border-slate-200 bg-white hover:bg-slate-50">
            <Bell className="h-4 w-4 text-slate-600" />
            <span className="absolute top-1.5 right-1.5 h-2 w-2 rounded-full bg-red-500" />
          </button>
          <Avatar className="h-9 w-9">
            <AvatarFallback className="bg-blue-100 text-blue-700 text-sm font-medium">MR</AvatarFallback>
          </Avatar>
        </header>
